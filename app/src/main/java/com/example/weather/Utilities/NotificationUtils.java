...
public class NotificationUtils {
    ...
    public static void notifyUserOfNewWeather(Context context) {
        ...
        if (todayWeatherCursor.moveToFirst()) {
            ...
            int largeArtResourceId = WeatherWeatherUtils
            ...
            int smallArtResourceId = WeatherWeatherUtils
    ...
    private static String getNotificationText(Context context, int weatherId, double high, double low) {
         ...
         */
        String shortDescription = WeatherWeatherUtils
        ...
        String notificationText = String.format(notificationFormat,
                shortDescription,
                WeatherWeatherUtils.formatTemperature(context, high),
                WeatherWeatherUtils.formatTemperature(context, low));
